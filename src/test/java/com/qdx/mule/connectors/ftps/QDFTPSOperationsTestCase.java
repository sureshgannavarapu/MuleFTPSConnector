package com.qdx.mule.connectors.ftps;
...
public class QDFTPSOperationsTestCase extends MuleArtifactFunctionalTestCase {

    /**
     * Specifies the mule config xml with the flows that are going to be executed in the tests, this
     * file lives in the test resources.
     */
    @Override
